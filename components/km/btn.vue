...
export default {
  setup(props) {
    ...
    const colors = {
      red: `border-red-500 ${
        outlined
          ? "text-red-400 active:bg-red-500/75 active:text-white hover:text-white hover:bg-red-500"
          : "bg-red-400"
      }`,
      ...
      success: ` border-green-500 ${
        outlined
          ? "text-green-400 active:bg-green-500/75 active:text-white hover:text-white hover:bg-green-500"
          : "bg-green-400"
      }`,
      info: `border-blue-500 ${
        outlined
          ? "text-blue-400 active:bg-blue-500/75 active:text-white hover:text-white hover:bg-blue-500"
          : "bg-blue-400"
      }`,
      blue: `border-blue-400 ${
        outlined
          ? "text-blue-600 active:bg-blue-400/75 active:text-white hover:text-white hover:bg-blue-400"
          : "bg-blue-600"
      }`,
      warning: `border-yellow-500 ${
        outlined
          ? "text-yellow-400 active:bg-yellow-500/75 active:text-white hover:text-white hover:bg-yellow-400"
          : "bg-yellow-400"
      }`,
      gray: `border-gray-500 ${
        outlined
          ? "text-gray-400 active:bg-gray-500/75 active:text-white hover:text-white hover:bg-gray-400"
          : "bg-gray-400 "
      }`,
